...
namespace model_glm_pp_poisson_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_glm_pp_poisson");
    ...
    reader.add_event(25, 3, "restart", "model_glm_pp_poisson");
    reader.add_event(74, 50, "end", "model_glm_pp_poisson");
    return reader;
}
...
class model_glm_pp_poisson
  : public stan::model::model_base_crtp<model_glm_pp_poisson> {
private:
        int nobs;
        int p;
        std::vector<int> y0;
        ...
        vector_d offset;
public:
    model_glm_pp_poisson(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_glm_pp_poisson_namespace::model_glm_pp_poisson";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "y0", "int", context__.to_vec(nobs));
            y0 = std::vector<int>(nobs, int(0));
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            validate_non_negative_index("eta", "((primitive_value(logical_neq(link, 2)) || primitive_value(logical_eq(incl_offset, 1))) ? nobs : 0 )", ((primitive_value(logical_neq(link, 2)) || primitive_value(logical_eq(incl_offset, 1))) ? nobs : 0 ));
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> eta(((primitive_value(logical_neq(link, 2)) || primitive_value(logical_eq(incl_offset, 1))) ? nobs : 0 ));
            stan::math::initialize(eta, DUMMY_VAR__);
            stan::math::fill(eta, DUMMY_VAR__);
            current_statement_begin__ = 51;
            validate_non_negative_index("mu", "(logical_neq(link, 2) ? nobs : 0 )", (logical_neq(link, 2) ? nobs : 0 ));
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> mu((logical_neq(link, 2) ? nobs : 0 ));
            ...
            if (as_bool(logical_gt(a0, 0))) {
                ...
                if (as_bool((primitive_value(logical_eq(link, 2)) && primitive_value(logical_eq(incl_offset, 0))))) {
                    ...
                    lp_accum__.add((a0 * poisson_log_glm_log(y0, X, 0, beta)));
                } else {
                    ...
                    if (as_bool(logical_eq(link, 2))) {
                        ...
                        lp_accum__.add((a0 * poisson_log_log(y0, eta)));
                    } else {
                        current_statement_begin__ = 67;
                        stan::math::assign(mu, linkinv(eta, link, pstream__));
                        current_statement_begin__ = 68;
                        lp_accum__.add((a0 * poisson_log(y0, mu)));
                    }
                }
            }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_glm_pp_poisson_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_glm_pp_poisson_namespace::model_glm_pp_poisson stan_model;
#ifndef USING_R
