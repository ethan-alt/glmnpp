...
namespace model_glm_pp_gaussian_post_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_glm_pp_gaussian_post");
    ...
    reader.add_event(25, 3, "restart", "model_glm_pp_gaussian_post");
    ...
    reader.add_event(81, 4, "restart", "model_glm_pp_gaussian_post");
    reader.add_event(161, 82, "end", "model_glm_pp_gaussian_post");
    return reader;
}
...
class model_glm_pp_gaussian_post
  : public stan::model::model_base_crtp<model_glm_pp_gaussian_post> {
private:
        int N;
        int N0;
        int K;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_glm_pp_gaussian_post_namespace::model_glm_pp_gaussian_post";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_glm_pp_gaussian_post_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_glm_pp_gaussian_post";
    }
...
typedef model_glm_pp_gaussian_post_namespace::model_glm_pp_gaussian_post stan_model;
#ifndef USING_R
