...
namespace model_glm_pp_fixed_bernoulli_post_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_glm_pp_fixed_bernoulli_post");
    ...
    reader.add_event(25, 3, "restart", "model_glm_pp_fixed_bernoulli_post");
    reader.add_event(86, 62, "end", "model_glm_pp_fixed_bernoulli_post");
    return reader;
}
...
class model_glm_pp_fixed_bernoulli_post
  : public stan::model::model_base_crtp<model_glm_pp_fixed_bernoulli_post> {
private:
        int N;
        int N0;
        int p;
        ...
        double a0;
public:
    model_glm_pp_fixed_bernoulli_post(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_glm_pp_fixed_bernoulli_post_namespace::model_glm_pp_fixed_bernoulli_post";
    ...
    ~model_glm_pp_fixed_bernoulli_post() { }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_glm_pp_fixed_bernoulli_post_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_glm_pp_fixed_bernoulli_post";
    }
...
typedef model_glm_pp_fixed_bernoulli_post_namespace::model_glm_pp_fixed_bernoulli_post stan_model;
#ifndef USING_R
