...
namespace model_glm_pp_invgaussian_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_glm_pp_invgaussian");
    ...
    reader.add_event(25, 3, "restart", "model_glm_pp_invgaussian");
    ...
    reader.add_event(31, 4, "restart", "model_glm_pp_invgaussian");
    reader.add_event(78, 49, "end", "model_glm_pp_invgaussian");
    return reader;
}
...
class model_glm_pp_invgaussian
  : public stan::model::model_base_crtp<model_glm_pp_invgaussian> {
private:
        int nobs;
        int p;
        vector_d y0;
        ...
        vector_d offset;
public:
    model_glm_pp_invgaussian(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_glm_pp_invgaussian_namespace::model_glm_pp_invgaussian";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "y0", "vector_d", context__.to_vec(nobs));
            y0 = Eigen::Matrix<double, Eigen::Dynamic, 1>(nobs);
            vals_r__ = context__.vals_r("y0");
            pos__ = 0;
            size_t y0_j_1_max__ = nobs;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_gt(a0, 0))) {
                ...
                lp_accum__.add((a0 * inversegaussian_lpdf(y0, mu, lambda, pstream__)));
            }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_glm_pp_invgaussian_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_glm_pp_invgaussian";
    }
...
typedef model_glm_pp_invgaussian_namespace::model_glm_pp_invgaussian stan_model;
#ifndef USING_R
