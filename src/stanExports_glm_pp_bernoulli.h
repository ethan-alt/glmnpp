...
namespace model_glm_pp_bernoulli_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_glm_pp_bernoulli");
    ...
    reader.add_event(25, 3, "restart", "model_glm_pp_bernoulli");
    reader.add_event(74, 50, "end", "model_glm_pp_bernoulli");
    return reader;
}
...
class model_glm_pp_bernoulli
  : public stan::model::model_base_crtp<model_glm_pp_bernoulli> {
private:
        int nobs;
        int p;
        std::vector<int> y0;
        ...
        vector_d offset;
public:
    model_glm_pp_bernoulli(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_glm_pp_bernoulli_namespace::model_glm_pp_bernoulli";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_glm_pp_bernoulli_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_glm_pp_bernoulli_namespace::model_glm_pp_bernoulli stan_model;
#ifndef USING_R
