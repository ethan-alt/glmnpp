...
#include "stanExports_lm_npp_gaussian.h"

RCPP_MODULE(stan_fit4lm_npp_gaussian_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_lm_npp_gaussian")
