...
#include "stanExports_lm_pp_gaussian_post.h"

RCPP_MODULE(stan_fit4lm_pp_gaussian_post_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_lm_pp_gaussian_post")
