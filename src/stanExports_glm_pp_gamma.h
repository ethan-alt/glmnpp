...
namespace model_glm_pp_gamma_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_glm_pp_gamma");
    ...
    reader.add_event(25, 3, "restart", "model_glm_pp_gamma");
    reader.add_event(72, 48, "end", "model_glm_pp_gamma");
    return reader;
}
...
class model_glm_pp_gamma
  : public stan::model::model_base_crtp<model_glm_pp_gamma> {
private:
        int nobs;
        int p;
        ...
        vector_d offset;
public:
    model_glm_pp_gamma(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_glm_pp_gamma_namespace::model_glm_pp_gamma";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_gt(a0, 0))) {
                ...
                lp_accum__.add((a0 * gamma_log(y0, alpha, multiply(alpha, inv(mu)))));
            }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_glm_pp_gamma_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_glm_pp_gamma_namespace::model_glm_pp_gamma stan_model;
#ifndef USING_R
