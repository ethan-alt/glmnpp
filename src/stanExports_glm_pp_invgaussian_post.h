...
namespace model_glm_pp_invgaussian_post_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_glm_pp_invgaussian_post");
    ...
    reader.add_event(25, 3, "restart", "model_glm_pp_invgaussian_post");
    reader.add_event(25, 3, "include", "/functions/finda0closest.stan");
    reader.add_event(25, 0, "start", "/functions/finda0closest.stan");
    reader.add_event(81, 56, "end", "/functions/finda0closest.stan");
    reader.add_event(81, 4, "restart", "model_glm_pp_invgaussian_post");
    reader.add_event(81, 4, "include", "/functions/inversegaussian_lpdf.stan");
    reader.add_event(81, 0, "start", "/functions/inversegaussian_lpdf.stan");
    reader.add_event(87, 6, "end", "/functions/inversegaussian_lpdf.stan");
    reader.add_event(87, 5, "restart", "model_glm_pp_invgaussian_post");
    reader.add_event(148, 64, "end", "model_glm_pp_invgaussian_post");
    return reader;
}
...
typename boost::math::tools::promote_args<T0__, T1__, T2__>::type
inversegaussian_lpdf(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& y,
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>((0.5 * (((rows(y) * stan::math::log((lambda / 6.283185307179586))) - (3 * sum(stan::math::log(y)))) - (lambda * dot_self(elt_multiply(subtract(y, mu), inv(elt_multiply(mu, stan::math::sqrt(y)))))))));
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        // Next line prevents compiler griping about no return
        throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
...
inversegaussian_lpdf(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& y,
                         const Eigen::Matrix<T1__, Eigen::Dynamic, 1>& mu,
                         const T2__& lambda, std::ostream* pstream__) {
    return inversegaussian_lpdf<false>(y,mu,lambda, pstream__);
}
struct inversegaussian_lpdf_functor__ {
    template <bool propto, typename T0__, typename T1__, typename T2__>
        typename boost::math::tools::promote_args<T0__, T1__, T2__>::type
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& y,
                         const Eigen::Matrix<T1__, Eigen::Dynamic, 1>& mu,
                         const T2__& lambda, std::ostream* pstream__) const {
        return inversegaussian_lpdf(y, mu, lambda, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_glm_pp_invgaussian_post
  : public stan::model::model_base_crtp<model_glm_pp_invgaussian_post> {
private:
        int N;
        int N0;
        int K;
        ...
        double disp_scale;
public:
    model_glm_pp_invgaussian_post(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_glm_pp_invgaussian_post_namespace::model_glm_pp_invgaussian_post";
        ...
        try {
            ...
            check_greater_or_equal(function__, "y0", y0, 0);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(lambda,inv(dispersion));
            ...
            lp_accum__.add((a0 * inversegaussian_lpdf(y0, mu0, lambda, pstream__)));
            current_statement_begin__ = 145;
            lp_accum__.add(inversegaussian_lpdf(y, mu, lambda, pstream__));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_glm_pp_invgaussian_post_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_glm_pp_invgaussian_post";
    }
...
typedef model_glm_pp_invgaussian_post_namespace::model_glm_pp_invgaussian_post stan_model;
#ifndef USING_R
